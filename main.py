...
def attack(char_name, char_class):
    """Function returns damage depending on the class."""
...
def defence(char_name, char_class):
    """Function returns blocked damage depending on the class."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Function described special skills."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """The function offers a choice of training.
    Depending on the class, different damage will be returned.
    """
    if char_class == 'warrior':
